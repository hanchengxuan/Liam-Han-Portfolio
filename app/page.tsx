...
const projects = [
  {
    ...
    description: 'A companion portal for the Conversational AI platform where users configure their own agents, push configuration updates in real time, and monitor live call activity.',
    stack: ['React', 'TypeScript', 'Python', 'SQL Server', 'Cosmos DB', 'Docker', 'Azure'],
    details: ['Built agent configuration screens for customer-managed conversational AI setup.', 'Connected portal changes to backend services so agent settings can update in real time.', 'Added operational views for monitoring real-time calls, interaction records, and booking-related activity.'],
    caseStudy: {
      problem: 'Users needed a self-serve way to configure conversational agents and monitor live calls without engineering support for every change.',
      role: 'Worked across portal UI, backend integration, database-backed configuration flows, and real-time operational views.',
      work: ['React/TypeScript agent configuration interface', 'Backend integration for real-time agent configuration updates', 'Live call and interaction monitoring views backed by operational data'],
      outcome: 'Gave users a clearer control surface for managing their agents while keeping configuration changes connected to the live Conversational AI system.',
      next: 'Improve audit history, configuration validation, and deeper live-call analytics for agent performance.',
    },
  },
  {
