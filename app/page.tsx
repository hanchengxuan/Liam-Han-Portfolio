...
const projects = [
  {
    ...
    description: 'A companion portal for the Conversational AI platform where users configure their own agents, sync changes to live agents, review real-time call logs, send call-log feedback to the team, and monitor agent performance dashboards.',
    stack: ['React', 'TypeScript', 'Python', 'SQL Server', 'Cosmos DB', 'Docker', 'Azure'],
    details: ['Built self-serve agent configuration screens for customer-managed conversational AI setup.', 'Connected portal configuration changes to backend services so live agents can update in real time.', 'Added real-time call log views, call log review feedback flows, team communication entry points, and agent performance dashboards.'],
    caseStudy: {
      problem: 'Users needed a self-serve control center for configuring conversational agents, reviewing live calls, and raising issues to the team without waiting for engineering support.',
      ...
      work: ['React/TypeScript agent configuration interface', 'Backend integration for real-time agent configuration updates', 'Real-time call log review, issue feedback, team communication, and dashboard views'],
      outcome: 'Gave users a clearer control surface for managing their agents, monitoring live call behavior, and feeding problems back to the team from the same portal.',
      next: 'Improve configuration audit history, validation before publishing, and deeper dashboard analytics for agent performance.',
    },
  },
  {
